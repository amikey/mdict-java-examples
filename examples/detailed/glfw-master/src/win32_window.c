                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_SIZE:
        {
			...
			//printf("win32_windowwin32_window%d", windowmy == NULL);
			if (onSizeChanged) {
				RECT r;
				//GetWindowRect(window->win32.handle, &r);
				GetClientRect(window->win32.handle, &r);
				onSizeChanged(r.right-r.left,r.bottom-r.top);
			}
                              ...
                              const _GLFWfbconfig* fbconfig)
{
    ...
    window->win32.handle = CreateWindowExW(exStyle,
                                           ...
                                           GLFWwindow_xpos, GLFWwindow_ypos,
                                           GLFWwindow_fullWidth==0?1024:GLFWwindow_fullWidth, GLFWwindow_fullHeight==0?768:GLFWwindow_fullHeight,
                              ...
                              const _GLFWfbconfig* fbconfig)
{
	...
	//printf("hahaha");
	//glfwGetWin32Window((GLFWwindow*)window);
	//
	//FILE *fp = fopen("F:\llloooogggg.text", "w+");
	//fflush 
	//fprintf(fp, "\n1hahaha,%d",sizeof(_GLFWwindow));
	//fprintf(fp, "\n2hahaha,%d", sizeof(_GLFWwindowWin32));
	//fprintf(fp, "\n3hahaha,%d", ((_GLFWwindow *)window)->win32);
	//fprintf(fp, "\n3hahaha,%d", (offsetof(_GLFWwindow, win32)));
	//fprintf(fp, "\n3hahaha,%d", ((_GLFWwindow *)window)->win32.handle == (HWND)(((byte*)window) + 832));
	//
	//
	////ShowWindow(*(HWND *)((char *)window + 832), SW_MAXIMIZE);
	////ShowWindow(((_GLFWwindow *)window)->win32.handle, SW_MAXIMIZE);
	//
	//
